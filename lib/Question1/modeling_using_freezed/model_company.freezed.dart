...
abstract class $CompanyCopyWith<$Res> {
  ...
  $Res call(
      ...
      String name,
      Address address,
      @JsonKey(name: 'established') DateTime established,
...
class _$CompanyImpl implements _Company {
  _$CompanyImpl(
      ...
      @JsonKey(name: 'established') required this.established,
...
abstract class _Company implements Company {
  factory _Company(
      ...
      @JsonKey(name: 'established') required final DateTime established,
